...
class WeatherBirthdays(BasePlugin):
    ...
    def generate_image(self, settings, device_config):
        ...
        template_params["birthdays"] = birthdays[:3]  # Limit to 3 birthdays
        ...
        image = self.render_image(dimensions, "weather_birthdays.html", "weather_birthdays.css", template_params)
    ...
    def parse_weather_data(self, weather_data, aqi_data, tz, units, time_format):
        ...
        data['data_points'] = self.parse_data_points(weather_data, aqi_data, tz, units, time_format, weather_plugin_dir)
    ...
    def parse_open_meteo_data(self, weather_data, aqi_data, tz, units, time_format):
        ...
        data = {
            ...
            "feels_like": str(round(current.get("temperature", 0))),
            "temperature_unit": UNITS[units]["temperature"],
            "units": units,
            "time_format": time_format
        }
        ...
        data['data_points'] = self.parse_open_meteo_data_points(weather_data, aqi_data, tz, units, time_format, weather_plugin_dir)
    ...
    def parse_forecast(self, daily_forecast, tz, icon_dir):
        ...
        for day in daily_forecast:
            ...
            moon_icon_path = os.path.join(icon_dir, f"icons/{phase_name}.png")
    ...
    def parse_data_points(self, weather, air_quality, tz, units, time_format, icon_dir):
        data_points = []
